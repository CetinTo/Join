function getInitials(fullName) {
  ...
  function getColorClass(name, contacts) {
    const contact = Object.values(contacts).find(c => c.name === name);
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    backButton.addEventListener('click', backToContactList);
    const headlineContact = document.querySelector('.contacts_headline');
    if (headlineContact) {
